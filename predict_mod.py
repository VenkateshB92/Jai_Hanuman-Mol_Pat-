...
def draw_graph(data, explanation, word, word1):
    ...
    # Calculate positions for the full graph (we'll use these later)
    ...
    # Create a visualization of all important subgraphs together
    fig, ax = plt.subplots()
    
    # Use the positions from the original graph for consistent layout
